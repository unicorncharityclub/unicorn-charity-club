                ...
                <form onSubmit={this.handleFormSubmit}>
                    ...
                    <div className="content_section">
                        <div className="page_details_content_main">
                            ...
                            <br/>
                            <TextTheme
                                message="Volunteer time at a local organization that supports the mission of the project."
                                className="text_medium text_black"/>
                            <div className="project-form-inner">
                                <Address
                                    changeHandler={this.props.changeHandler}/>
                                <TextTheme message="2. How much time did you volunteer?"
                                ...
                                <TextTheme message="3. Describe what you did to volunteer your time."
                                           className="text_medium text_black"/><br/>
                                ...
                                <TextTheme
                                    message="3. Share a video or photo that celebrates your volunteer experience."
                                    className="text_medium text_black"/>
                            </div>
                            <br/>
