                ...
                <ProjectInfo id={this.state.projectId} />
                    ...
                    <TextTheme message="Challenge 3: Adventure" className="text_large text_blue" />
                      ...
                      <TextTheme message="FUNDRAISE" className="text_medium text_black" />
                        <br/>
                        <TextTheme message="Fundraise money for a local organization that supports the mission of the project." className="text_medium text_black" />
                        <div className="project-form-inner">
                            <Address
                                changeHandler = {this.props.changeHandler}/>
                                <TextTheme message="2. How much money did you raise in your fundraiser?" className="text_medium text_black" /><br/>
                            ...
                            <TextTheme message="3. Describe what you did in your fundraiser." className="text_medium text_black" /><br/>
                              <TextArea name="description" rows={3} cols={80}
                                     ...
                                     <TextTheme message="3. Share a video or photo that celebrates your fundraising experience." className="text_medium text_black" />
                          </div>
                    <br/>
