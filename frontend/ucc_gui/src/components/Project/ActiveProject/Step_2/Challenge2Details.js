                    ...
                    <form onSubmit={this.handleFormSubmit}>
                        <div className="page_details_main">
                            <div className="page_details_content_main">
                                ...
                                <br/>
                                <TextTheme
                                    message="1. How can I make a difference? Explore the following impact adventures and set your project goal."
                                    className="text_medium text_black"/>
                                <ul style={{paddingLeft: "60px"}}>
                                    <br/>

                                    <div className="OptionList">
                                        <input name="Option" type="radio" value="1" checked={this.state.checked}
                                               onClick={this.props.handleChecked}/>
                                        <label htmlFor="Option"> <TextTheme
                                            message="Spread the word by inviting 5+ friends to the project"
                                            className="text_small text_black"/></label><br/>
                                        <br/>

                                        <input name="Option" type="radio" value="2" checked={this.state.checked}
                                               onClick={this.props.handleChecked}/>
                                        <label htmlFor="Option"> <TextTheme
                                            message="Learn a new skill that supports the mission"
                                            className="text_small text_black"/></label><br/>
                                        <br/>

                                        <input name="Option" type="radio" value="3" checked={this.state.checked}
                                               onClick={this.props.handleChecked}/>
                                        <label htmlFor="Option"> <TextTheme
                                            message="Develop a new habit that supports the mission"
                                            className="text_small text_black"/></label><br/>
                                        <br/>

                                        <input name="Option" type="radio" value="4" checked={this.state.checked}
                                               onClick={this.props.handleChecked}/>
                                        <label htmlFor="Option"> <TextTheme
                                            message="Volunteer time at a local organization"
                                            className="text_small text_black"/></label><br/>
                                        <br/>

                                        <input name="Option" type="radio" value="5" checked={this.state.checked}
                                               onClick={this.props.handleChecked}/>
                                        <label htmlFor="Option"> <TextTheme
                                            message="Give a donation to support the mission"
                                            className="text_small text_black"/></label><br/>
                                        <br/>

                                        <input name="Option" type="radio" value="6" checked={this.state.checked}
                                               onClick={this.props.handleChecked}/>
                                        <label htmlFor="Option"> <TextTheme
                                            message="Fundraise money to support the mission"
                                            className="text_small text_black"/></label><br/>
                                        <br/>
                                    </div>
                                </ul>
                                <br/>
                                <TextTheme message="2. Set a target date to complete your goal:"
                                           className="text_medium text_black"/>
                                <br/>
                                ...
                                <br/>
                                <br/>
                                <TwoButtonLayout button1Text="SAVE" button2Text="NEXT"
                                                 button2Click={this.props.onSubmit}/>
